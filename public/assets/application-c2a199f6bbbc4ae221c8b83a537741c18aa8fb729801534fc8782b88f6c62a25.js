...
(function() {
  ...
  Feedback = (function() {
    ...
    function Feedback(options) {
      ...
      this.id_el = this.form_el.find("input.textfield");
        ...
        this.form_el.submit((function(_this) {
          return function(e) {
            ...
            return $.getJSON(form.attr("action") + '.json', {
              ...
              feedback_text: msg,
              feedback_id: form[0]["feedback_id"].value,
...
(function() {
  ...
  Constituents = (function() {
    function Constituents(options) {
      $(".map img").click((function(_this) {
        return function(map) {
          return _this.clickZoom(map);
        };
      })(this));
      this;
    }

    Constituents.prototype.clickZoom = function(element) {
      var img, is_big, map, src;
      map = $(element.target);
  ...
  $(function() {
    return window._co = new Constituents();
  });
